        ...
        <div className="dashboard-container">
            ...
            <div className="calendar-overflow-frame">
                ...
                <div className="calendar-iframe-body">
                    <iframe src="https://calendar.google.com/calendar/embed?height=600&wkst=1&ctz=Asia%2FKolkata&showPrint=0&src=Y29udGFjdEBzYW5kZWJ0ZWNoLmNvbQ&color=%23039be5" style="border:solid 1px #777" width="800" height="600" frameborder="0" scrolling="no"></iframe>
                </div>
            </div>
        </div>
    );
